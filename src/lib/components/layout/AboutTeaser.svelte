...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Aidan Guo",
		role: "CEO & Cofounder",
		image: "/generated/image-a-professional-headshot-of-a-young-asian.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"After watching brilliant engineers lose hours to context switching, we knew there had to be a better way. Attention isn't just another productivity tool - it's a proactive AI that learns your patterns and executes tasks before you even ask."`}
			/>
